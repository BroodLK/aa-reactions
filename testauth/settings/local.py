...
# substituting your domain for aareactions.com
...
ESI_USER_CONTACT_EMAIL = "dummy@aareactions.net"
...
# Set the default from email to something like 'noreply@aareactions.com'
